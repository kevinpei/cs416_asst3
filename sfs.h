...
#define direct_blocks_Inode ((BLOCK_SIZE - 4 * sizeof(int) - sizeof(mode_t) - sizeof(size_t) - sizeof(uid_t) - sizeof(gid_t) - sizeof(time_t) - sizeof(blkcnt_t) - PATH_MAX * sizeof(char)) / sizeof(int))
